...
FEATURES = [
    ...
    "atr_14","volume_z","volume_ratio","volume_price_trend",
    "momentum_3d","momentum_10d","momentum_30d","accel_5d",
    "hl_spread","hl_ma","gap","gap_ma","range_ma",
    "stoch_k","stoch_d","williams_r","cci","mfi",
    "spy_ret","spy_corr","vix","vix_change",
    "price_distance_ma20","price_distance_ma50",
    "volume_surge","price_trend_strength",
    "volatility_rank","returns_skew","returns_kurt",
]
